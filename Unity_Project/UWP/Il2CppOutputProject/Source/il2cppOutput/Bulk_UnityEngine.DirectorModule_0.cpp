...
extern const RuntimeMethod* PlayableDirector_SendOnPlayableDirectorPause_m4E43A08D82CCE58DE75A1D9605A716BD85837F81_RuntimeMethod_var;
extern const RuntimeMethod* PlayableDirector_SendOnPlayableDirectorPlay_m4E9920374473D4726C270EF6ECACA93303C7BA87_RuntimeMethod_var;
extern const RuntimeMethod* PlayableDirector_SendOnPlayableDirectorStop_mB1699B938518B0D2CBB70B6A7678FBA8A83839A8_RuntimeMethod_var;
extern const RuntimeType* PlayableDirector_tAE05A3F910B71FA6BC7EED28C26C35945308D2B2_0_0_0_var;
...
extern "C" IL2CPP_METHOD_ATTR void PlayableDirector_SendOnPlayableDirectorPlay_m4E9920374473D4726C270EF6ECACA93303C7BA87 (PlayableDirector_tAE05A3F910B71FA6BC7EED28C26C35945308D2B2 * __this, const RuntimeMethod* method)
{
	...
	CHECK_SEQ_POINT(methodExecutionContext, 17263);
	CHECK_METHOD_EXIT_SEQ_POINT(methodExitChecker, methodExecutionContext, 17264);
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17265);
		CHECK_SEQ_POINT(methodExecutionContext, 17266);
	...
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17267);
		Action_1_t25E50453F931760A3FC110C4EC79B73BBC203021 * L_1 = __this->get_played_4();
		CHECK_SEQ_POINT(methodExecutionContext, 17268);
		STORE_SEQ_POINT(methodExecutionContext, 17270);
		NullCheck(L_1, il2cpp_codegen_get_sequence_point(17268));
		...
		CHECK_SEQ_POINT(methodExecutionContext, 17270);
	}

IL_0018:
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17269);
		return;
	}
}
...
extern "C" IL2CPP_METHOD_ATTR void PlayableDirector_SendOnPlayableDirectorPause_m4E43A08D82CCE58DE75A1D9605A716BD85837F81 (PlayableDirector_tAE05A3F910B71FA6BC7EED28C26C35945308D2B2 * __this, const RuntimeMethod* method)
{
	...
	CHECK_SEQ_POINT(methodExecutionContext, 17271);
	CHECK_METHOD_EXIT_SEQ_POINT(methodExitChecker, methodExecutionContext, 17272);
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17273);
		CHECK_SEQ_POINT(methodExecutionContext, 17274);
	...
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17275);
		Action_1_t25E50453F931760A3FC110C4EC79B73BBC203021 * L_1 = __this->get_paused_5();
		CHECK_SEQ_POINT(methodExecutionContext, 17276);
		STORE_SEQ_POINT(methodExecutionContext, 17278);
		NullCheck(L_1, il2cpp_codegen_get_sequence_point(17276));
		Action_1_Invoke_mE8C21024872FD84A7DB7C11BE8A207AD3A97C537(L_1, __this, /*hidden argument*/Action_1_Invoke_mE8C21024872FD84A7DB7C11BE8A207AD3A97C537_RuntimeMethod_var);
		CHECK_SEQ_POINT(methodExecutionContext, 17278);
	}

IL_0018:
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17277);
		return;
	}
}
...
extern "C" IL2CPP_METHOD_ATTR void PlayableDirector_SendOnPlayableDirectorStop_mB1699B938518B0D2CBB70B6A7678FBA8A83839A8 (PlayableDirector_tAE05A3F910B71FA6BC7EED28C26C35945308D2B2 * __this, const RuntimeMethod* method)
{
	...
	CHECK_SEQ_POINT(methodExecutionContext, 17279);
	CHECK_METHOD_EXIT_SEQ_POINT(methodExitChecker, methodExecutionContext, 17280);
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17281);
		CHECK_SEQ_POINT(methodExecutionContext, 17282);
	...
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17283);
		Action_1_t25E50453F931760A3FC110C4EC79B73BBC203021 * L_1 = __this->get_stopped_6();
		CHECK_SEQ_POINT(methodExecutionContext, 17284);
		STORE_SEQ_POINT(methodExecutionContext, 17286);
		NullCheck(L_1, il2cpp_codegen_get_sequence_point(17284));
		Action_1_Invoke_mE8C21024872FD84A7DB7C11BE8A207AD3A97C537(L_1, __this, /*hidden argument*/Action_1_Invoke_mE8C21024872FD84A7DB7C11BE8A207AD3A97C537_RuntimeMethod_var);
		CHECK_SEQ_POINT(methodExecutionContext, 17286);
	}

IL_0018:
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17285);
		return;
	}
}
#ifdef __clang__
