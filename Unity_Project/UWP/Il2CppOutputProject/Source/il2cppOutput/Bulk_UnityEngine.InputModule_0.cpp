...
extern const RuntimeMethod* NativeInputSystem_NotifyBeforeUpdate_m317D534DBDD42915CE638051B87E48B76ED28574_RuntimeMethod_var;
extern const RuntimeMethod* NativeInputSystem_NotifyDeviceDiscovered_m48C3818DDCFB1A2C0530B6CE1C78743ABA4614B0_RuntimeMethod_var;
extern const RuntimeMethod* NativeInputSystem_NotifyUpdate_m9AAC791622BA97DC7807610DD08C54F6011834F2_RuntimeMethod_var;
extern const RuntimeMethod* NativeInputSystem__cctor_m062AB23A2EB8CDEC8BEB378C4588038BD1614A11_RuntimeMethod_var;
extern const RuntimeType* Action_1_tA0A72999A108CE29CD4CB14537B8FE41501859C1_0_0_0_var;
extern const RuntimeType* Action_2_t3DE7FA14577DE01568F76D409273F315827CAA36_0_0_0_var;
extern const RuntimeType* NativeInputEventBufferU2A_t0D5FBD73D852ED51D29EF57078626FA67B4DC810_0_0_0_var;
extern const RuntimeType* NativeUpdateCallback_tCC4B5A2692C21C00FC2FC1E4EC5280E98423B8D5_0_0_0_var;
...
extern const uint32_t NativeInputSystem__cctor_m062AB23A2EB8CDEC8BEB378C4588038BD1614A11_MetadataUsageId;
...
extern "C" IL2CPP_METHOD_ATTR void NativeInputSystem__cctor_m062AB23A2EB8CDEC8BEB378C4588038BD1614A11 (const RuntimeMethod* method)
{
	...
	CHECK_SEQ_POINT(methodExecutionContext, 17287);
	CHECK_METHOD_EXIT_SEQ_POINT(methodExitChecker, methodExecutionContext, 17288);
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17289);
		CHECK_SEQ_POINT(methodExecutionContext, 17290);
		CHECK_SEQ_POINT(methodExecutionContext, 17291);
		STORE_SEQ_POINT(methodExecutionContext, 17293);
		NativeInputSystem_set_hasDeviceDiscoveredCallback_mB5319D5A7C245D6F12C294928D4AF3B635FFE362((bool)0, /*hidden argument*/NULL);
		CHECK_SEQ_POINT(methodExecutionContext, 17293);
		CHECK_SEQ_POINT(methodExecutionContext, 17292);
		return;
	}
}
...
extern "C" IL2CPP_METHOD_ATTR void NativeInputSystem_NotifyBeforeUpdate_m317D534DBDD42915CE638051B87E48B76ED28574 (int32_t ___updateType0, const RuntimeMethod* method)
{
	...
	CHECK_SEQ_POINT(methodExecutionContext, 17294);
	CHECK_METHOD_EXIT_SEQ_POINT(methodExitChecker, methodExecutionContext, 17295);
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17296);
		CHECK_SEQ_POINT(methodExecutionContext, 17297);
		...
		V_0 = L_0;
		CHECK_SEQ_POINT(methodExecutionContext, 17298);
	...
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17299);
		Action_1_tA0A72999A108CE29CD4CB14537B8FE41501859C1 * L_2 = V_0;
		int32_t L_3 = ___updateType0;
		CHECK_SEQ_POINT(methodExecutionContext, 17300);
		STORE_SEQ_POINT(methodExecutionContext, 17302);
		NullCheck(L_2, il2cpp_codegen_get_sequence_point(17300));
		...
		CHECK_SEQ_POINT(methodExecutionContext, 17302);
	}

IL_0014:
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17301);
		return;
	}
}
...
extern "C" IL2CPP_METHOD_ATTR void NativeInputSystem_NotifyUpdate_m9AAC791622BA97DC7807610DD08C54F6011834F2 (int32_t ___updateType0, intptr_t ___eventBuffer1, const RuntimeMethod* method)
{
	...
	CHECK_SEQ_POINT(methodExecutionContext, 17303);
	CHECK_METHOD_EXIT_SEQ_POINT(methodExitChecker, methodExecutionContext, 17304);
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17305);
		CHECK_SEQ_POINT(methodExecutionContext, 17306);
		IL2CPP_RUNTIME_CLASS_INIT(NativeInputSystem_t522F6391494159917EE6963E9E61C9EFA9C5795C_il2cpp_TypeInfo_var);
		...
		V_0 = L_0;
		CHECK_SEQ_POINT(methodExecutionContext, 17307);
		CHECK_SEQ_POINT(methodExecutionContext, 17308);
		STORE_SEQ_POINT(methodExecutionContext, 17319);
		void* L_1 = IntPtr_ToPointer_mC56A17E597E9F767B889DA10DB866F0B96CF0D65((intptr_t*)(&___eventBuffer1), /*hidden argument*/NULL);
		CHECK_SEQ_POINT(methodExecutionContext, 17319);
		V_1 = (NativeInputEventBuffer_t9960648276F01C5C3435E0E6FD870F2DA8A132EF *)L_1;
		CHECK_SEQ_POINT(methodExecutionContext, 17309);
	...
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17310);
		CHECK_SEQ_POINT(methodExecutionContext, 17311);
		NativeInputEventBuffer_t9960648276F01C5C3435E0E6FD870F2DA8A132EF * L_3 = V_1;
		NullCheck(L_3, il2cpp_codegen_get_sequence_point(17311));
		L_3->set_eventCount_1(0);
		CHECK_SEQ_POINT(methodExecutionContext, 17312);
		NativeInputEventBuffer_t9960648276F01C5C3435E0E6FD870F2DA8A132EF * L_4 = V_1;
		NullCheck(L_4, il2cpp_codegen_get_sequence_point(17312));
		L_4->set_sizeInBytes_2(0);
		CHECK_SEQ_POINT(methodExecutionContext, 17313);
		goto IL_0034;
	}

IL_002a:
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17314);
		CHECK_SEQ_POINT(methodExecutionContext, 17315);
		...
		CHECK_SEQ_POINT(methodExecutionContext, 17316);
		STORE_SEQ_POINT(methodExecutionContext, 17320);
		NullCheck(L_5, il2cpp_codegen_get_sequence_point(17316));
		...
		CHECK_SEQ_POINT(methodExecutionContext, 17320);
		CHECK_SEQ_POINT(methodExecutionContext, 17317);
	}

IL_0034:
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17318);
		return;
	}
}
...
extern "C" IL2CPP_METHOD_ATTR void NativeInputSystem_NotifyDeviceDiscovered_m48C3818DDCFB1A2C0530B6CE1C78743ABA4614B0 (int32_t ___deviceId0, String_t* ___deviceDescriptor1, const RuntimeMethod* method)
{
	...
	CHECK_SEQ_POINT(methodExecutionContext, 17321);
	CHECK_METHOD_EXIT_SEQ_POINT(methodExitChecker, methodExecutionContext, 17322);
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17323);
		CHECK_SEQ_POINT(methodExecutionContext, 17324);
		IL2CPP_RUNTIME_CLASS_INIT(NativeInputSystem_t522F6391494159917EE6963E9E61C9EFA9C5795C_il2cpp_TypeInfo_var);
		...
		V_0 = L_0;
		CHECK_SEQ_POINT(methodExecutionContext, 17325);
	...
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17326);
		Action_2_t3DE7FA14577DE01568F76D409273F315827CAA36 * L_2 = V_0;
		int32_t L_3 = ___deviceId0;
		String_t* L_4 = ___deviceDescriptor1;
		CHECK_SEQ_POINT(methodExecutionContext, 17327);
		STORE_SEQ_POINT(methodExecutionContext, 17329);
		NullCheck(L_2, il2cpp_codegen_get_sequence_point(17327));
		...
		CHECK_SEQ_POINT(methodExecutionContext, 17329);
	}

IL_0015:
	{
		CHECK_SEQ_POINT(methodExecutionContext, 17328);
		return;
	}
}
// System.Void UnityEngineInternal.Input.NativeInputSystem::set_hasDeviceDiscoveredCallback(System.Boolean)
