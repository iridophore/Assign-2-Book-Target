...
extern const RuntimeMethod* NavMesh_Internal_CallOnNavMeshPreUpdate_mED6CAB94A6CB61A5FD547B7026DB4C96F2AF5B60_RuntimeMethod_var;
...
extern "C" IL2CPP_METHOD_ATTR void NavMesh_Internal_CallOnNavMeshPreUpdate_mED6CAB94A6CB61A5FD547B7026DB4C96F2AF5B60 (const RuntimeMethod* method)
{
	...
	CHECK_SEQ_POINT(methodExecutionContext, 16840);
	CHECK_METHOD_EXIT_SEQ_POINT(methodExitChecker, methodExecutionContext, 16841);
	{
		CHECK_SEQ_POINT(methodExecutionContext, 16842);
		CHECK_SEQ_POINT(methodExecutionContext, 16843);
	...
	{
		CHECK_SEQ_POINT(methodExecutionContext, 16844);
		...
		CHECK_SEQ_POINT(methodExecutionContext, 16845);
		STORE_SEQ_POINT(methodExecutionContext, 16847);
		NullCheck(L_1, il2cpp_codegen_get_sequence_point(16845));
		OnNavMeshPreUpdate_Invoke_mE56CD30B200FECFD94AD4B22923B32BD789D70F0(L_1, /*hidden argument*/NULL);
		CHECK_SEQ_POINT(methodExecutionContext, 16847);
	}

IL_0015:
	{
		CHECK_SEQ_POINT(methodExecutionContext, 16846);
		return;
	}
}
#ifdef __clang__
